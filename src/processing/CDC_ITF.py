...
def transform(record: dict, key_ref: dict, country_ref: pd.DataFrame, who_coding: pd.DataFrame):
    ...
    record = utils.replace_conditional(record, 'country_territory_area', 'CuraA§ao', 'Curacao')
    record = utils.replace_conditional(record, 'country_territory_area', 'Curaçao', 'Curacao')
    record = utils.replace_conditional(record, 'country_territory_area', 'CuraÇõao', 'Curacao')
